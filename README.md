...
The analysis is performed in Python 3.8.10 and presented in a Jupyter notebook format. The virtual environment needed to run the notebook can be recreated by using the included requirements.txt.
